(new Image(1,1)).src=("https://consent.trustarc.com/log".replace("http:","https:"))+"?domain=squarespace.com&country=us&state=ca&behavior=implied&c="+(((1+Math.random())*65536)|0).toString(16).substring(1);
...
}}}}return false}(function trustarcBanner(){var e=truste.eu.bindMap={version:"v1.7-1745",domain:"squarespace.com",width:parseInt("660"),height:parseInt("456"),baseName:"te-notice-clr1-5bfa5e58-0124-43b2-bc90-bb3e95e15a23",showOverlay:"{ShowLink}",hideOverlay:"{HideLink}",anchName:"te-notice-clr1-5bfa5e58-0124-43b2-bc90-bb3e95e15a23-anch",intDivName:"te-notice-clr1-5bfa5e58-0124-43b2-bc90-bb3e95e15a23-itl",iconSpanId:"te-notice-clr1-5bfa5e58-0124-43b2-bc90-bb3e95e15a23-icon",containerId:(!"teconsent"||/^_LB.*LB_$/.test("teconsent"))?"teconsent":"teconsent",messageBaseUrl:"http://consent.trustarc.com/noticemsg?",originBaseUrl:"https://consent.trustarc.com/",daxSignature:"",privacyUrl:"",prefmgrUrl:"http://consent-pref.trustarc.com/?type=squarespace2_ccpa",text:"true",icon:"Do not sell my info",locale:"en",language:"en",country:"us",state:"ca",categoryCount:parseInt("3",10)||3,noticeJsURL:((parseInt("0")?"https://consent.trustarc.com/":"http://consent.trustarc.com/"))+"asset/notice.js/v/v1.7-1745",assetServerURL:(parseInt("0")?"https://consent.trustarc.com/":"http://consent.trustarc.com/")+"asset/",consensuUrl:"https://trustarc.mgr.consensu.org/",cdnURL:"https://consent.trustarc.com/".replace(/^(http:)?\/\//,"https://"),iconBaseUrl:"http://consent.trustarc.com/",behavior:"implied",behaviorManager:"us",provisionedFeatures:"",cookiePreferenceIcon:"truste_adchoices.png",cookieExpiry:parseInt("395",10)||395,closeButtonUrl:"https://consent.trustarc.com/get?name=icon_cross_large.svg",apiDefaults:'{"reportlevel":16777215}',cmTimeout:parseInt("6000",10),popTime:new Date("".replace(" +0000","Z").replace(" ","T")).getTime()||null,popupMsg:"",bannerMsgURL:"http://consent.trustarc.com/bannermsg?",IRMIntegrationURL:"",irmWidth:parseInt(""),irmHeight:parseInt(""),irmContainerId:(!"_LBirmcLB_"||/^_LB.*LB_$/.test("_LBirmcLB_"))?"teconsent":"_LBirmcLB_",irmText:"",lspa:"",ccpaText:"",containerRole:"",iconRole:"",atpIds:"",feat:{iabGdprApplies:false,consentResolution:false,dropBehaviorCookie:true,crossDomain:false,uidEnabled:false,replaceDelimiter:false,enableBanner:false,enableIRM:false,enableCM:true,enableCCPA:false,enableIrmAutoOptOut:false,ccpaApplies:false,enableCM:true,unprovisionedDropBehavior:true,unprovisionedIab:false,unprovisionedCCPA:false,dnt:false&&(navigator.doNotTrack=="1"||window.doNotTrack=="1"),dntShowUI:false,iabBannerApplies:false,enableTwoStepVerification:false,enableContainerRole:true,enableIconRole:true,enableReturnFocus:false,enableShopify:0,enableReturnFocus:false,enableTcfOptout:false,enableTransparentAlt:true,enableACString:false},autoDisplayCloseButton:false};
...
}}}truste.eu.noticeLP=truste.eu.noticeLP||{};truste.eu.noticeLP.pcookie=true;(function(f){var m=function(o){if(f.feat.iab){return
...
f()}})(truste.eu.bindMap);$temp_box_overlay={padding:"0px"};$temp_closebtn_style={top:"32px",left:"40px"};
